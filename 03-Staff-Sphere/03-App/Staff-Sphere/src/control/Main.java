		...
		try {
			...
			persons[1] = 
					new Manager(1002, "Ahmed", "Mohammed", "22 Shebieen eg", "01116050171",
							Gender.Male, LocalDate.of(2003, 10, 18), "#123pppppp44", 7000.12, "IS", "IS.manager.ahmed@ABC.com");

			persons[2] = 
					new Admin(1003, "Hoda", "Adel", "123 Cairo eg", "01501630099",
							Gender.Female, LocalDate.of(2000, 5, 12), 8000.12, "admin.hoda@ABC.com", "12345@@@");
